...
function twoSum(arr, int){
  ...
  // iterate through the array, checking if two numbers add up to the int
  // if it does, return the indices of those numbers
  ...
  console.log("TWO SUMS", twoSum([2,7,11,15],26)) // [2,3]
  console.log("TWO SUMS", twoSum([2,7,11,15],9)) // [0,1]
  console.log("TWO SUMS", twoSum([3,2,4],6)) // [1,2]
  console.log("TWO SUMS", twoSum([3,3],6)) // [0,1]


  // exactly one solution, and you may not use the same element twice.
  // indices must be returned in the same relative order that they appear within the array.
